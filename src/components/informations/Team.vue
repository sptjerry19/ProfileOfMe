      ...
      <div class="flex flex-wrap flex-row -mx-4 justify-center">
        ...
        >
          ...
          >
            ...
            <div class="pt-6 text-center">
              <p class="text-lg leading-normal font-bold mb-1">Jerry Phạm</p>
              <p class="text-gray-500 leading-relaxed font-light">Developer</p>
              <!-- social icon -->
        ...
        >
          ...
          >
            ...
            <div class="pt-6 text-center">
              <p class="text-lg leading-normal font-bold mb-1">Đắc Hiếu</p>
        ...
        >
          ...
          >
            ...
            <div class="pt-6 text-center">
              <p class="text-lg leading-normal font-bold mb-1">Vĩ Minh</p>
        ...
        >
          ...
          >
            ...
            <div class="pt-6 text-center">
              <p class="text-lg leading-normal font-bold mb-1">Quang Kiên</p>
              <p class="text-gray-500 leading-relaxed font-light">
                UI/UX Designer
              </p>
              <!-- social icon -->
    ...
    <div class="container px-6 py-10 mx-auto">
      <div class="xl:flex xl:items-center xL:-mx-4">
        ...
        >
          <div>
            <img
              class="object-cover rounded-xl h-64 w-full"
